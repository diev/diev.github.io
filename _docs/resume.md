...
Июнь 2008 - по настоящее время (9 лет)
...
FinCERT), ФСБ, ФСТЭК (ПДн), СМЭВ, Казначейство, Московская Биржа, 
...
Верба-OW, Сигнатура, Валидата, CryptoPRO, PKI, GPG, PGP, SSH.*
...
* *Наглядный просмотр и работа с архивом посылок ПТК ПСД, прием и 
отправка платежной XML информации, бинарных информационных и файлов 
статистики по HTTP протоколу в СВК Банка России (собственный аналог UTA): 
JS HTA, PowerShell.*
...
cистемы управления конфигурациями. Банковские базы данных (АБС) 
