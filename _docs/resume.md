...
разбор XML УФЕБС из АРМ КБР и перераспределение по заданным спискам 
платежей (например, обслуживание по разным тарифам, клиентские и 
банковские), рассылка оповещений через SMTP по заданным адресам и 
критериям: 
C#.*

* *Соавтор популярных в банковской среде программ SVKTrans и PTK PSD 
Browser - прием и отправка платежной XML информации, бинарных информационных 
и файлов статистики по HTTP протоколу в СВК Банка России (собственный аналог 
UTA) и гораздо более наглядная работа с архивом посылок ПТК ПСД: 
JS HTA, PowerShell.*

* *Информационная система для получения информации о состоянии 
банковских карточек и счетов через Интернет, а также система 
администрирования в Интранет: 
